...
namespace TechStockWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private TechStockWebUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<TechStockWebUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(TechStockWebUser)}'. " +
                    $"Ensure that '{nameof(TechStockWebUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
