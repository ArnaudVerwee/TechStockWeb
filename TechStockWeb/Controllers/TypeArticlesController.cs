...
namespace TechStockWeb.Controllers
{
    public class TypeArticlesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type")] TypeArticle typeArticle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type")] TypeArticle typeArticle)
        {
